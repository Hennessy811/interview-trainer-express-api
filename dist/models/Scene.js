...
exports.getScenario = exports.listScenarios = exports.createScenario = exports.Scene = void 0;
...
], Scene.prototype, "tags", void 0);
__decorate([
    typegoose_1.prop(),
    __metadata("design:type", Object)
], Scene.prototype, "sections", void 0);
__decorate([
    typegoose_1.prop(),
    __metadata("design:type", Settings)
], Scene.prototype, "settings", void 0);
exports.Scene = Scene;
// Get User model
const ScenarioModel = typegoose_1.getModelForClass(Scene, {
